...
@section('content')
    <p>
        To set your {{ config('app.versionName') }} password, please enter your new password twice, and then press
        the "Set Password" button to confirm the change.
    </p>
    <p>
    ...
    <form method="POST" action="{{ route('password.change.set') }}" class="form-horizontal">
        @csrf
