...
if (!array_key_exists("skuId", $_REQUEST)) {
    echo "<script>location='admin-fulfillment-item.php';</script>";
    die();
}
...
if (array_key_exists("all", $_REQUEST)) {
    ...
    echo "<script>location='admin-fulfillment-item.php?skuId=$skuId';</script>";
}
    ...
    <section class="site-content site-section">
        <div class="container">
            ...
            <div class="list-group">
                ...
                <button type=button class='btn btn-primary btn-sm' onclick="location='admin-makeShippingList.php?skuId=<?php echo $skuId; ?>';">Download Shipping List</button>
                &nbsp;<button type=button class='btn btn-primary btn-sm' onclick="location='?all=1&skuId=<?php echo $skuId; ?>';">Mark All Shipped</button>
            </div>
            <div class="container">
                <div id="mainMenu">
